...
OUT = Path("上海交通大学_开题答辩PPT模板_深蓝苹果风.pptx")
...
def build_slides() -> list[base.Slide]:
    ...
    s.add(base.text_box(s.sid(), "cover subtitle", e(0.94), e(4.1), e(7.6), e(0.42), p("深蓝苹果风开题答辩模板", size=1420, color=SOFT)))
...
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties"
  ...
  <dc:title>上海交通大学开题答辩PPT模板_深蓝苹果风</dc:title>
  <dc:subject>开题答辩模板</dc:subject>
  <dc:creator>Codex</dc:creator>
  <cp:keywords>上海交通大学; SJTU; 开题答辩; PPT模板; 深蓝; Apple style</cp:keywords>
  <dc:description>使用上海交通大学视觉形象识别系统官方附件生成的深蓝苹果风开题答辩模板。</dc:description>
